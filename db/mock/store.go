...
// Source: github.com/MikoBerries/SimpleBank/db/sqlc (interfaces: Store)
...
// CreataUserTx mocks base method.
func (m *MockStore) CreataUserTx(arg0 context.Context, arg1 db.CreataUserTxParams) (db.CreataUserTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreataUserTx", arg0, arg1)
	ret0, _ := ret[0].(db.CreataUserTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreataUserTx indicates an expected call of CreataUserTx.
func (mr *MockStoreMockRecorder) CreataUserTx(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreataUserTx", reflect.TypeOf((*MockStore)(nil).CreataUserTx), arg0, arg1)
}
...
// ListEEntry mocks base method.
func (m *MockStore) ListEEntry(arg0 context.Context) ([]db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEEntry", arg0)
	ret0, _ := ret[0].([]db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListEEntry indicates an expected call of ListEEntry.
func (mr *MockStoreMockRecorder) ListEEntry(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEEntry", reflect.TypeOf((*MockStore)(nil).ListEEntry), arg0)
}

// ListTransferById mocks base method.
func (m *MockStore) ListTransferById(arg0 context.Context) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransferById", arg0)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTransferById indicates an expected call of ListTransferById.
func (mr *MockStoreMockRecorder) ListTransferById(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransferById", reflect.TypeOf((*MockStore)(nil).ListTransferById), arg0)
}
